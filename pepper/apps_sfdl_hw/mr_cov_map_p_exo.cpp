#include <apps_sfdl_hw/mr_cov_map_p_exo.h>
...
#include <apps_sfdl/mr_cov_map.c>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

mr_cov_mapProverExo::mr_cov_mapProverExo() { 
  baseline_minimal_input_size = sizeof(MapperIn);
  baseline_minimal_output_size = sizeof(MapperOut);
}

using namespace mr_cov_map_cons;

void mr_cov_mapProverExo::init_exo_inputs(
...
void mr_cov_mapProverExo::export_exo_inputs(
...
void mr_cov_mapProverExo::run_shuffle_phase(char *folder_path) {

}

void mr_cov_mapProverExo::baseline_minimal(void* input, void* output){
...
void mr_cov_mapProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/mr_cov_map_cons.h for constants to use in this exogenous
//check.
bool mr_cov_mapProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
