#ifndef APPS_SFDL_GEN_RLE_DECODE_FLAT_P_EXO_H_
#define APPS_SFDL_GEN_RLE_DECODE_FLAT_P_EXO_H_

#include <apps_sfdl_gen/rle_decode_flat_p.h>
...
*/
class rle_decode_flatProverExo : public ExogenousChecker {
  public:
    rle_decode_flatProverExo();
...
#endif  // APPS_SFDL_GEN_RLE_DECODE_FLAT_P_EXO_H_
