#ifndef APPS_SFDL_GEN_KMPSEARCH_DFA_P_EXO_H_
#define APPS_SFDL_GEN_KMPSEARCH_DFA_P_EXO_H_

#include <apps_sfdl_gen/kmpsearch_dfa_p.h>
...
*/
class kmpsearch_dfaProverExo : public ExogenousChecker {
  public:
    kmpsearch_dfaProverExo();
...
#endif  // APPS_SFDL_GEN_KMPSEARCH_DFA_P_EXO_H_
