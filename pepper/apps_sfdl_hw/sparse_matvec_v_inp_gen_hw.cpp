...
#include <apps_sfdl_hw/sparse_matvec_v_inp_gen_hw.h>
#include <apps_sfdl_gen/sparse_matvec_cons.h>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

sparse_matvecVerifierInpGenHw::sparse_matvecVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/sparse_matvec_cons.h for constants to use when generating input.
using sparse_matvec_cons::N;
using sparse_matvec_cons::K;
void sparse_matvecVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
  #if IS_REDUCER == 0
