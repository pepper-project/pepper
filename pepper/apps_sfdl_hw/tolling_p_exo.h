#ifndef APPS_SFDL_GEN_TOLLING_P_EXO_H_
#define APPS_SFDL_GEN_TOLLING_P_EXO_H_

#include <apps_sfdl_gen/tolling_p.h>
...
*/
class tollingProverExo : public ExogenousChecker {
  public:
    tollingProverExo();
...
#endif  // APPS_SFDL_GEN_TOLLING_P_EXO_H_
