#ifndef APPS_SFDL_GEN_MR_COV_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_COV_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_cov_map_p.h>
...
*/
class mr_cov_mapProverExo : public ExogenousChecker {
  public:
    mr_cov_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_COV_MAP_P_EXO_H_
