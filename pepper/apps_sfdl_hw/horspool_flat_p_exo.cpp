#include <apps_sfdl_hw/horspool_flat_p_exo.h>
...
horspool_flatProverExo::horspool_flatProverExo() {
...
void horspool_flatProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void horspool_flatProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void horspool_flatProverExo::run_shuffle_phase(char *folder_path) {

}

void horspool_flatProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}
...
void horspool_flatProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/horspool_flat_cons.h for constants to use in this exogenous
//check.
bool horspool_flatProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
