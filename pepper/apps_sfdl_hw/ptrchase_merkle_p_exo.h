#ifndef APPS_SFDL_GEN_PTRCHASE_MERKLE_P_EXO_H_
#define APPS_SFDL_GEN_PTRCHASE_MERKLE_P_EXO_H_

#include <apps_sfdl_gen/ptrchase_merkle_p.h>
...
*/
class ptrchase_merkleProverExo : public ExogenousChecker {
  public:
    ptrchase_merkleProverExo();
...
#endif  // APPS_SFDL_GEN_PTRCHASE_MERKLE_P_EXO_H_
