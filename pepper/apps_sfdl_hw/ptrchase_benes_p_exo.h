#ifndef APPS_SFDL_GEN_PTRCHASE_BENES_P_EXO_H_
#define APPS_SFDL_GEN_PTRCHASE_BENES_P_EXO_H_

#include <apps_sfdl_gen/ptrchase_benes_p.h>
...
*/
class ptrchase_benesProverExo : public ExogenousChecker {
  public:
    ptrchase_benesProverExo();
...
#endif  // APPS_SFDL_GEN_PTRCHASE_BENES_P_EXO_H_
