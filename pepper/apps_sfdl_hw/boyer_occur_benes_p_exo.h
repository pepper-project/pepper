#ifndef APPS_SFDL_GEN_BOYER_OCCUR_BENES_P_EXO_H_
#define APPS_SFDL_GEN_BOYER_OCCUR_BENES_P_EXO_H_

#include <apps_sfdl_gen/boyer_occur_benes_p.h>
...
*/
class boyer_occur_benesProverExo : public ExogenousChecker {
  public:
    boyer_occur_benesProverExo();
...
#endif  // APPS_SFDL_GEN_BOYER_OCCUR_BENES_P_EXO_H_
