#include <apps_sfdl_hw/cql_ro_eq_p_exo.h>
...
#include <apps_sfdl/cql_ro_eq.h>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

cql_ro_eqProverExo::cql_ro_eqProverExo() { }

using namespace cql_ro_eq_cons;

void cql_ro_eqProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
}

void cql_ro_eqProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void cql_ro_eqProverExo::run_shuffle_phase(char *folder_path) {
...
void cql_ro_eqProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/cql_ro_eq_cons.h for constants to use in this exogenous
//check.
bool cql_ro_eqProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
