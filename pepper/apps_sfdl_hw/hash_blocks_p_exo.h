#ifndef APPS_SFDL_GEN_HASH_BLOCKS_P_EXO_H_
#define APPS_SFDL_GEN_HASH_BLOCKS_P_EXO_H_

#include <apps_sfdl_gen/hash_blocks_p.h>
...
*/
class hash_blocksProverExo : public ExogenousChecker {
  public:
    hash_blocksProverExo();
...
#endif  // APPS_SFDL_GEN_HASH_BLOCKS_P_EXO_H_
