#ifndef APPS_SFDL_GEN_MERGESORT_BENES_P_EXO_H_
#define APPS_SFDL_GEN_MERGESORT_BENES_P_EXO_H_

#include <apps_sfdl_gen/mergesort_benes_p.h>
...
*/
class mergesort_benesProverExo : public ExogenousChecker {
  public:
    mergesort_benesProverExo();
...
#endif  // APPS_SFDL_GEN_MERGESORT_BENES_P_EXO_H_
