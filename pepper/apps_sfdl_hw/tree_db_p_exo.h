#ifndef APPS_SFDL_GEN_TREE_DB_P_EXO_H_
#define APPS_SFDL_GEN_TREE_DB_P_EXO_H_

#include <apps_sfdl_gen/tree_db_p.h>
...
*/
class tree_dbProverExo : public ExogenousChecker {
  public:
    tree_dbProverExo();
...
#endif  // APPS_SFDL_GEN_TREE_DB_P_EXO_H_
