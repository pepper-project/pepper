#ifndef APPS_SFDL_GEN_GENOME_SNP_FREQ_P_EXO_H_
#define APPS_SFDL_GEN_GENOME_SNP_FREQ_P_EXO_H_

#include <apps_sfdl_gen/genome_snp_freq_p.h>
...
*/
class genome_snp_freqProverExo : public ExogenousChecker {
  public:
    genome_snp_freqProverExo();
...
#endif  // APPS_SFDL_GEN_GENOME_SNP_FREQ_P_EXO_H_
