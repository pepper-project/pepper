#include <apps_sfdl_hw/mr_dist_search_map_p_exo.h>
...
#include <apps_sfdl/mr_dist_search_map.c>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

mr_dist_search_mapProverExo::mr_dist_search_mapProverExo() { 
...
void mr_dist_search_mapProverExo::init_exo_inputs(
...
void mr_dist_search_mapProverExo::export_exo_inputs(
...
void mr_dist_search_mapProverExo::run_shuffle_phase(char *folder_path) {

}

void mr_dist_search_mapProverExo::baseline_minimal(void* input, void*
output){
...
void mr_dist_search_mapProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/mr_dist_search_map_cons.h for constants to use in this exogenous
//check.
bool mr_dist_search_mapProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
