#ifndef APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_substring_search_map_p.h>
...
*/
class mr_substring_search_mapProverExo : public ExogenousChecker {
  public:
    mr_substring_search_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_MAP_P_EXO_H_
