#ifndef APPS_SFDL_GEN_BITWISE_ROTATE_P_EXO_H_
#define APPS_SFDL_GEN_BITWISE_ROTATE_P_EXO_H_

#include <apps_sfdl_gen/bitwise_rotate_p.h>
...
*/
class bitwise_rotateProverExo : public ExogenousChecker {
  public:
    bitwise_rotateProverExo();
...
#endif  // APPS_SFDL_GEN_BITWISE_ROTATE_P_EXO_H_
