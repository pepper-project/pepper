...
#include <apps_sfdl_hw/memcpy_merkle_v_inp_gen_hw.h>
...
memcpy_merkleVerifierInpGenHw::memcpy_merkleVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/memcpy_merkle_cons.h for constants to use when generating input.
void memcpy_merkleVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
  #if IS_REDUCER == 0
