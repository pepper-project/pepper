#ifndef APPS_SFDL_GEN_MR_BSTORE_VECADD_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_BSTORE_VECADD_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_bstore_vecadd_map_p.h>
...
*/
class mr_bstore_vecadd_mapProverExo : public ExogenousChecker {
  public:
    mr_bstore_vecadd_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_BSTORE_VECADD_MAP_P_EXO_H_
