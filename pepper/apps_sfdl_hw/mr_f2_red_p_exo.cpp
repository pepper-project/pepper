#include <apps_sfdl_hw/mr_f2_red_p_exo.h>
...
#include <apps_sfdl/mr_f2_red.c>

mr_f2_redProverExo::mr_f2_redProverExo() { 
...
void mr_f2_redProverExo::init_exo_inputs(
...
void mr_f2_redProverExo::export_exo_inputs(
...
void mr_f2_redProverExo::run_shuffle_phase(char *folder_path) {
  run_mapred_shuffle_phase(NUM_MAPPERS, NUM_REDUCERS, NUM_HASH_CHUNKS*NUM_MAPPERS, folder_path);
}

void mr_f2_redProverExo::baseline_minimal(void* input, void* output){
  ReducerIn* reducer_in = (ReducerIn*)input;
  ReducerOut* reducer_out = (ReducerOut*)output;

  ::reduce(reducer_in, reducer_out);
}

void mr_f2_redProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/mr_f2_red_cons.h for constants to use in this exogenous
//check.
bool mr_f2_redProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
