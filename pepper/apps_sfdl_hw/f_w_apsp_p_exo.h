#ifndef APPS_SFDL_GEN_F_W_APSP_P_EXO_H_
#define APPS_SFDL_GEN_F_W_APSP_P_EXO_H_

#include <apps_sfdl_gen/f_w_apsp_p.h>
...
*/
class f_w_apspProverExo : public ExogenousChecker {
  public:
    f_w_apspProverExo();
...
#endif  // APPS_SFDL_GEN_F_W_APSP_P_EXO_H_
