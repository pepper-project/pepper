#ifndef APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_substring_search_red_p.h>
...
*/
class mr_substring_search_redProverExo : public ExogenousChecker {
  public:
    mr_substring_search_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_SUBSTRING_SEARCH_RED_P_EXO_H_
