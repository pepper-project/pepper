#ifndef APPS_SFDL_GEN_FAST_RAM_TEST_P_EXO_H_
#define APPS_SFDL_GEN_FAST_RAM_TEST_P_EXO_H_

#include <apps_sfdl_gen/fast_ram_test_p.h>
...
*/
class fast_ram_testProverExo : public ExogenousChecker {
  public:
    fast_ram_testProverExo();
...
#endif  // APPS_SFDL_GEN_FAST_RAM_TEST_P_EXO_H_
