#ifndef APPS_SFDL_GEN_MR_COV_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_COV_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_cov_red_p.h>
...
*/
class mr_cov_redProverExo : public ExogenousChecker {
  public:
    mr_cov_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_COV_RED_P_EXO_H_
