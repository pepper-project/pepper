#include <apps_sfdl_hw/kmpsearch_p_exo.h>
...
kmpsearchProverExo::kmpsearchProverExo() {
...
void kmpsearchProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void kmpsearchProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void kmpsearchProverExo::run_shuffle_phase(char *folder_path) {

}

void kmpsearchProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

using kmpsearch_cons::NEEDLE;
using kmpsearch_cons::HAYSTACK;
void kmpsearchProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/kmpsearch_cons.h for constants to use in this exogenous
//check.
bool kmpsearchProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
