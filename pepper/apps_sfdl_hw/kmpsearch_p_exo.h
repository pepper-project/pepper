#ifndef APPS_SFDL_GEN_KMPSEARCH_P_EXO_H_
#define APPS_SFDL_GEN_KMPSEARCH_P_EXO_H_

#include <apps_sfdl_gen/kmpsearch_p.h>
...
*/
class kmpsearchProverExo : public ExogenousChecker {
  public:
    kmpsearchProverExo();
...
#endif  // APPS_SFDL_GEN_KMPSEARCH_P_EXO_H_
