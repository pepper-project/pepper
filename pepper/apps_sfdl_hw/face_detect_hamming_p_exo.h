#ifndef APPS_SFDL_GEN_FACE_DETECT_HAMMING_P_EXO_H_
#define APPS_SFDL_GEN_FACE_DETECT_HAMMING_P_EXO_H_

#include <apps_sfdl_gen/face_detect_hamming_p.h>
...
*/
class face_detect_hammingProverExo : public ExogenousChecker {
  public:
    face_detect_hammingProverExo();
...
#endif  // APPS_SFDL_GEN_FACE_DETECT_HAMMING_P_EXO_H_
