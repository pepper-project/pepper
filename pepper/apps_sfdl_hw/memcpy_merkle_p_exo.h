#ifndef APPS_SFDL_GEN_MEMCPY_MERKLE_P_EXO_H_
#define APPS_SFDL_GEN_MEMCPY_MERKLE_P_EXO_H_

#include <apps_sfdl_gen/memcpy_merkle_p.h>
...
*/
class memcpy_merkleProverExo : public ExogenousChecker {
  public:
    memcpy_merkleProverExo();
...
#endif  // APPS_SFDL_GEN_MEMCPY_MERKLE_P_EXO_H_
