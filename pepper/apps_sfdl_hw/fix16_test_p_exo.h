#ifndef APPS_SFDL_GEN_FIX16_TEST_P_EXO_H_
#define APPS_SFDL_GEN_FIX16_TEST_P_EXO_H_

#include <apps_sfdl_gen/fix16_test_p.h>
...
*/
class fix16_testProverExo : public ExogenousChecker {
  public:
    fix16_testProverExo();
...
#endif  // APPS_SFDL_GEN_FIX16_TEST_P_EXO_H_
