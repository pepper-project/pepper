#include <apps_sfdl_hw/kmpsearch_flat_p_exo.h>
...
kmpsearch_flatProverExo::kmpsearch_flatProverExo() {
...
void kmpsearch_flatProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void kmpsearch_flatProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void kmpsearch_flatProverExo::run_shuffle_phase(char *folder_path) {

}

void kmpsearch_flatProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

using kmpsearch_flat_cons::NEEDLE;
using kmpsearch_flat_cons::HAYSTACK;
void kmpsearch_flatProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/kmpsearch_flat_cons.h for constants to use in this exogenous
//check.
bool kmpsearch_flatProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
