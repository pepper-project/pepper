#ifndef APPS_SFDL_GEN_SPARSE_MATVEC_FLAT_P_EXO_H_
#define APPS_SFDL_GEN_SPARSE_MATVEC_FLAT_P_EXO_H_

#include <apps_sfdl_gen/sparse_matvec_flat_p.h>
...
*/
class sparse_matvec_flatProverExo : public ExogenousChecker {
  public:
    sparse_matvec_flatProverExo();
...
#endif  // APPS_SFDL_GEN_SPARSE_MATVEC_FLAT_P_EXO_H_
