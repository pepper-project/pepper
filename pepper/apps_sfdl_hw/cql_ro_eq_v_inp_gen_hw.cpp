...
#include <apps_sfdl_hw/cql_ro_eq_v_inp_gen_hw.h>
...
cql_ro_eqVerifierInpGenHw::cql_ro_eqVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/cql_ro_eq_cons.h for constants to use when generating input.
void cql_ro_eqVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
  if (generate_states) {
