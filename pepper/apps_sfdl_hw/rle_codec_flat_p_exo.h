#ifndef APPS_SFDL_GEN_RLE_CODEC_FLAT_P_EXO_H_
#define APPS_SFDL_GEN_RLE_CODEC_FLAT_P_EXO_H_

#include <apps_sfdl_gen/rle_codec_flat_p.h>
...
*/
class rle_codec_flatProverExo : public ExogenousChecker {
  public:
    rle_codec_flatProverExo();
...
#endif  // APPS_SFDL_GEN_RLE_CODEC_FLAT_P_EXO_H_
