#include <apps_sfdl_hw/rle_codec_p_exo.h>
...
rle_codecProverExo::rle_codecProverExo() {
...
void rle_codecProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void rle_codecProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void rle_codecProverExo::run_shuffle_phase(char *folder_path) {

}

void rle_codecProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

using rle_codec_cons::SIZE;
void rle_codecProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/rle_codec_cons.h for constants to use in this exogenous
//check.
bool rle_codecProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
