#ifndef APPS_SFDL_GEN_CQL_RO_RANGE_P_EXO_H_
#define APPS_SFDL_GEN_CQL_RO_RANGE_P_EXO_H_

#include <apps_sfdl_gen/cql_ro_range_p.h>
...
*/
class cql_ro_rangeProverExo : public ExogenousChecker {
  public:
    cql_ro_rangeProverExo();
...
#endif  // APPS_SFDL_GEN_CQL_RO_RANGE_P_EXO_H_
