#ifndef APPS_SFDL_GEN_MR_GENOTYPER_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_GENOTYPER_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_genotyper_map_p.h>
...
*/
class mr_genotyper_mapProverExo : public ExogenousChecker {
  public:
    mr_genotyper_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_GENOTYPER_MAP_P_EXO_H_
