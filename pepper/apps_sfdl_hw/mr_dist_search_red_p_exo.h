#ifndef APPS_SFDL_GEN_MR_DIST_SEARCH_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_DIST_SEARCH_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_dist_search_red_p.h>
#include <apps_sfdl_gen/mr_dist_search_red_v_inp_gen.h>
#include <apps_sfdl_hw/mr_dist_search_red_v_inp_gen_hw.h>
...
*/
class mr_dist_search_redProverExo : public ExogenousChecker {
  public:
    mr_dist_search_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_DIST_SEARCH_RED_P_EXO_H_
