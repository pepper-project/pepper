#ifndef APPS_SFDL_GEN_PURE_HASHGET_P_EXO_H_
#define APPS_SFDL_GEN_PURE_HASHGET_P_EXO_H_

#include <apps_sfdl_gen/pure_hashget_p.h>
...
*/
class pure_hashgetProverExo : public ExogenousChecker {
  public:
    pure_hashgetProverExo();
...
#endif  // APPS_SFDL_GEN_PURE_HASHGET_P_EXO_H_
