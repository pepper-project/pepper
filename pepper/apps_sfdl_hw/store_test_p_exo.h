#ifndef APPS_SFDL_GEN_STORE_TEST_P_EXO_H_
#define APPS_SFDL_GEN_STORE_TEST_P_EXO_H_

#include <apps_sfdl_gen/store_test_p.h>
...
*/
class store_testProverExo : public ExogenousChecker {
  public:
    store_testProverExo();
...
#endif  // APPS_SFDL_GEN_STORE_TEST_P_EXO_H_
