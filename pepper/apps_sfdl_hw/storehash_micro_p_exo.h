#ifndef APPS_SFDL_GEN_STOREHASH_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_STOREHASH_MICRO_P_EXO_H_

#include <apps_sfdl_gen/storehash_micro_p.h>
...
*/
class storehash_microProverExo : public ExogenousChecker {
  public:
    storehash_microProverExo();
...
#endif  // APPS_SFDL_GEN_STOREHASH_MICRO_P_EXO_H_
