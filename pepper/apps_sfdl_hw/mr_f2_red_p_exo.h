#ifndef APPS_SFDL_GEN_MR_F2_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_F2_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_f2_red_p.h>
...
*/
class mr_f2_redProverExo : public ExogenousChecker {
  public:
    mr_f2_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_F2_RED_P_EXO_H_
