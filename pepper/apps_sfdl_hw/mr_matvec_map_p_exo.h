#ifndef APPS_SFDL_GEN_MR_MATVEC_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_MATVEC_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_matvec_map_p.h>
...
*/
class mr_matvec_mapProverExo : public ExogenousChecker {
  public:
    mr_matvec_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_MATVEC_MAP_P_EXO_H_
