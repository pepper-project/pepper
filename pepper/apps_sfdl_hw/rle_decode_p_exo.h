#ifndef APPS_SFDL_GEN_RLE_DECODE_P_EXO_H_
#define APPS_SFDL_GEN_RLE_DECODE_P_EXO_H_

#include <apps_sfdl_gen/rle_decode_p.h>
...
*/
class rle_decodeProverExo : public ExogenousChecker {
  public:
    rle_decodeProverExo();
...
#endif  // APPS_SFDL_GEN_RLE_DECODE_P_EXO_H_
