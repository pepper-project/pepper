#ifndef APPS_SFDL_GEN_RAMGET_FAST_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_RAMGET_FAST_MICRO_P_EXO_H_

#include <apps_sfdl_gen/ramget_fast_micro_p.h>
...
*/
class ramget_fast_microProverExo : public ExogenousChecker {
  public:
    ramget_fast_microProverExo();
...
#endif  // APPS_SFDL_GEN_RAMGET_FAST_MICRO_P_EXO_H_
