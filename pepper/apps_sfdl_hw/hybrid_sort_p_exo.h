#ifndef APPS_SFDL_GEN_HYBRID_SORT_P_EXO_H_
#define APPS_SFDL_GEN_HYBRID_SORT_P_EXO_H_

#include <apps_sfdl_gen/hybrid_sort_p.h>
...
*/
class hybrid_sortProverExo : public ExogenousChecker {
  public:
    hybrid_sortProverExo();
...
#endif  // APPS_SFDL_GEN_HYBRID_SORT_P_EXO_H_
