#ifndef APPS_SFDL_GEN_SHA_1_P_EXO_H_
#define APPS_SFDL_GEN_SHA_1_P_EXO_H_

#include <apps_sfdl_gen/sha_1_p.h>
...
*/
class sha_1ProverExo : public ExogenousChecker {
  public:
    sha_1ProverExo();
...
#endif  // APPS_SFDL_GEN_SHA_1_P_EXO_H_
