#ifndef APPS_SFDL_GEN_RIDGE_REGRESSION_P_EXO_H_
#define APPS_SFDL_GEN_RIDGE_REGRESSION_P_EXO_H_

#include <apps_sfdl_gen/ridge_regression_p.h>
...
*/
class ridge_regressionProverExo : public ExogenousChecker {
  public:
    ridge_regressionProverExo();
...
#endif  // APPS_SFDL_GEN_RIDGE_REGRESSION_P_EXO_H_
