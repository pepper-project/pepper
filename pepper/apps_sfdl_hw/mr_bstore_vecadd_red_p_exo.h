#ifndef APPS_SFDL_GEN_MR_BSTORE_VECADD_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_BSTORE_VECADD_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_bstore_vecadd_red_p.h>
...
*/
class mr_bstore_vecadd_redProverExo : public ExogenousChecker {
  public:
    mr_bstore_vecadd_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_BSTORE_VECADD_RED_P_EXO_H_
