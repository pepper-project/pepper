#ifndef APPS_SFDL_GEN_RAMPUT_FAST_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_RAMPUT_FAST_MICRO_P_EXO_H_

#include <apps_sfdl_gen/ramput_fast_micro_p.h>
...
*/
class ramput_fast_microProverExo : public ExogenousChecker {
  public:
    ramput_fast_microProverExo();
...
#endif  // APPS_SFDL_GEN_RAMPUT_FAST_MICRO_P_EXO_H_
