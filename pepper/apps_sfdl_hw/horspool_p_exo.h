#ifndef APPS_SFDL_GEN_HORSPOOL_P_EXO_H_
#define APPS_SFDL_GEN_HORSPOOL_P_EXO_H_

#include <apps_sfdl_gen/horspool_p.h>
...
*/
class horspoolProverExo : public ExogenousChecker {
  public:
    horspoolProverExo();
...
#endif  // APPS_SFDL_GEN_HORSPOOL_P_EXO_H_
