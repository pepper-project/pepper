#ifndef APPS_SFDL_GEN_MR_VECADD_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_VECADD_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_vecadd_map_p.h>
...
*/
class mr_vecadd_mapProverExo : public ExogenousChecker {
  public:
    mr_vecadd_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_VECADD_MAP_P_EXO_H_
