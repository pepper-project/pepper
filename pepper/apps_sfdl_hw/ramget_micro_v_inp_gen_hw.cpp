...
#include <apps_sfdl_hw/ramget_micro_v_inp_gen_hw.h>
...
ramget_microVerifierInpGenHw::ramget_microVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/ramget_micro_cons.h for constants to use when generating input.
void ramget_microVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
  #if IS_REDUCER == 0
