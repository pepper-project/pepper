#ifndef APPS_SFDL_GEN_HASHGET_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_HASHGET_MICRO_P_EXO_H_

#include <apps_sfdl_gen/hashget_micro_p.h>
...
*/
class hashget_microProverExo : public ExogenousChecker {
  public:
    hashget_microProverExo();
...
#endif  // APPS_SFDL_GEN_HASHGET_MICRO_P_EXO_H_
