#include <apps_sfdl_hw/mr_substring_search_red_p_exo.h>
#include <apps_sfdl_gen/mr_substring_search_red_cons.h>
#include <common/sha1.h>
#include <storage/configurable_block_store.h>
#include <apps_sfdl_hw/mr_substring_search_red_v_inp_gen_hw.h>

#pragma pack(push)
#pragma pack(1)

#include <apps_sfdl/mr_substring_search_red.c>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

mr_substring_search_redProverExo::mr_substring_search_redProverExo() {
  baseline_minimal_input_size = sizeof(ReducerIn);
  baseline_minimal_output_size = sizeof(ReducerOut);
}


void mr_substring_search_redProverExo::init_exo_inputs(
...
void mr_substring_search_redProverExo::export_exo_inputs(
...
void mr_substring_search_redProverExo::run_shuffle_phase(char *folder_path) {
 run_mapred_shuffle_phase(NUM_MAPPERS, NUM_REDUCERS, NUM_HASH_CHUNKS*NUM_MAPPERS, folder_path);
}

void mr_substring_search_redProverExo::baseline_minimal(void* input,
void* output){
...
void mr_substring_search_redProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/mr_substring_search_red_cons.h for constants to use in this exogenous
//check.
bool mr_substring_search_redProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
