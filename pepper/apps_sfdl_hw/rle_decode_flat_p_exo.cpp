#include <apps_sfdl_hw/rle_decode_flat_p_exo.h>
...
rle_decode_flatProverExo::rle_decode_flatProverExo() {
...
void rle_decode_flatProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {

}

void rle_decode_flatProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void rle_decode_flatProverExo::run_shuffle_phase(char *folder_path) {

}

void rle_decode_flatProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

using rle_decode_flat_cons::OUTPUT_SIZE;
void rle_decode_flatProverExo::baseline(const mpq_t* input_q, int num_inputs,
...
//Refer to apps_sfdl_gen/rle_decode_flat_cons.h for constants to use in this exogenous
//check.
bool rle_decode_flatProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
