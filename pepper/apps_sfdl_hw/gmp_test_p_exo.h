#ifndef APPS_SFDL_GEN_GMP_TEST_P_EXO_H_
#define APPS_SFDL_GEN_GMP_TEST_P_EXO_H_

#include <apps_sfdl_gen/gmp_test_p.h>
...
*/
class gmp_testProverExo : public ExogenousChecker {
  public:
    gmp_testProverExo();
...
#endif  // APPS_SFDL_GEN_GMP_TEST_P_EXO_H_
