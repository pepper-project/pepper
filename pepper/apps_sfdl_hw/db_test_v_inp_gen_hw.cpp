...
#include <apps_sfdl_hw/db_test_v_inp_gen_hw.h>
...
db_testVerifierInpGenHw::db_testVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/db_test_cons.h for constants to use when generating input.
void db_testVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
