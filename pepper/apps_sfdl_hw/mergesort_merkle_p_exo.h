#ifndef APPS_SFDL_GEN_MERGESORT_MERKLE_P_EXO_H_
#define APPS_SFDL_GEN_MERGESORT_MERKLE_P_EXO_H_

#include <apps_sfdl_gen/mergesort_merkle_p.h>
...
*/
class mergesort_merkleProverExo : public ExogenousChecker {
  public:
    mergesort_merkleProverExo();
...
#endif  // APPS_SFDL_GEN_MERGESORT_MERKLE_P_EXO_H_
