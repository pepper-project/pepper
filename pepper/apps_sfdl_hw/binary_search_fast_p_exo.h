#ifndef APPS_SFDL_GEN_BINARY_SEARCH_FAST_P_EXO_H_
#define APPS_SFDL_GEN_BINARY_SEARCH_FAST_P_EXO_H_

#include <apps_sfdl_gen/binary_search_fast_p.h>
...
*/
class binary_search_fastProverExo : public ExogenousChecker {
  public:
    binary_search_fastProverExo();
...
#endif  // APPS_SFDL_GEN_BINARY_SEARCH_FAST_P_EXO_H_
