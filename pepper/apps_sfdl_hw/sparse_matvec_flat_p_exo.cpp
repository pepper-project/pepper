#include <apps_sfdl_hw/sparse_matvec_flat_p_exo.h>
...
sparse_matvec_flatProverExo::sparse_matvec_flatProverExo() {
...
void sparse_matvec_flatProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void sparse_matvec_flatProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void sparse_matvec_flatProverExo::run_shuffle_phase(char *folder_path) {

}

void sparse_matvec_flatProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

using sparse_matvec_flat_cons::N;
using sparse_matvec_flat_cons::K;
void sparse_matvec_flatProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/sparse_matvec_flat_cons.h for constants to use in this exogenous
//check.
bool sparse_matvec_flatProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
