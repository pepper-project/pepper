#ifndef APPS_SFDL_GEN_RAM_MERKLE_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_RAM_MERKLE_MICRO_P_EXO_H_

#include <apps_sfdl_gen/ram_merkle_micro_p.h>
...
*/
class ram_merkle_microProverExo : public ExogenousChecker {
  public:
    ram_merkle_microProverExo();
...
#endif  // APPS_SFDL_GEN_RAM_MERKLE_MICRO_P_EXO_H_
