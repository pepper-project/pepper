#ifndef APPS_SFDL_GEN_HORSPOOL_FLAT_P_EXO_H_
#define APPS_SFDL_GEN_HORSPOOL_FLAT_P_EXO_H_

#include <apps_sfdl_gen/horspool_flat_p.h>
...
*/
class horspool_flatProverExo : public ExogenousChecker {
  public:
    horspool_flatProverExo();
...
#endif  // APPS_SFDL_GEN_HORSPOOL_FLAT_P_EXO_H_
