#ifndef APPS_SFDL_GEN_KMPSEARCH_FLAT_P_EXO_H_
#define APPS_SFDL_GEN_KMPSEARCH_FLAT_P_EXO_H_

#include <apps_sfdl_gen/kmpsearch_flat_p.h>
...
*/
class kmpsearch_flatProverExo : public ExogenousChecker {
  public:
    kmpsearch_flatProverExo();
...
#endif  // APPS_SFDL_GEN_KMPSEARCH_FLAT_P_EXO_H_
