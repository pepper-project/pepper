#ifndef APPS_SFDL_GEN_TREE_RANGE_TEST_P_EXO_H_
#define APPS_SFDL_GEN_TREE_RANGE_TEST_P_EXO_H_

#include <apps_sfdl_gen/tree_range_test_p.h>
...
*/
class tree_range_testProverExo : public ExogenousChecker {
  public:
    tree_range_testProverExo();
...
#endif  // APPS_SFDL_GEN_TREE_RANGE_TEST_P_EXO_H_
