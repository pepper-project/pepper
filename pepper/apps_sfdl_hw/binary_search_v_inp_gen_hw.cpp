...
#include <apps_sfdl_hw/binary_search_v_inp_gen_hw.h>
...
binary_searchVerifierInpGenHw::binary_searchVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/binary_search_cons.h for constants to use when generating input.
void binary_searchVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
