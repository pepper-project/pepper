#include <apps_sfdl_hw/mr_dist_search_red_p_exo.h>
...
#include <apps_sfdl/mr_dist_search_red.c>

//This file will NOT be overwritten by the code generator, if it already
//exists. make clean will also not remove this file.

mr_dist_search_redProverExo::mr_dist_search_redProverExo() { 
...
void mr_dist_search_redProverExo::init_exo_inputs(
...
void mr_dist_search_redProverExo::export_exo_inputs(
...
void mr_dist_search_redProverExo::run_shuffle_phase(char *folder_path) {
  run_mapred_shuffle_phase(NUM_MAPPERS, NUM_REDUCERS, NUM_HASH_CHUNKS*NUM_MAPPERS, folder_path);
}

void mr_dist_search_redProverExo::baseline_minimal(void* input, void*
output){
...
void mr_dist_search_redProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/mr_dist_search_red_cons.h for constants to use in this exogenous
//check.
bool mr_dist_search_redProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
