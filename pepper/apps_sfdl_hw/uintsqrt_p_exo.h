#ifndef APPS_SFDL_GEN_UINTSQRT_P_EXO_H_
#define APPS_SFDL_GEN_UINTSQRT_P_EXO_H_

#include <apps_sfdl_gen/uintsqrt_p.h>
...
*/
class uintsqrtProverExo : public ExogenousChecker {
  public:
    uintsqrtProverExo();
...
#endif  // APPS_SFDL_GEN_UINTSQRT_P_EXO_H_
