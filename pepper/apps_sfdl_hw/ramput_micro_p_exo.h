#ifndef APPS_SFDL_GEN_RAMPUT_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_RAMPUT_MICRO_P_EXO_H_

#include <apps_sfdl_gen/ramput_micro_p.h>
...
*/
class ramput_microProverExo : public ExogenousChecker {
  public:
    ramput_microProverExo();
...
#endif  // APPS_SFDL_GEN_RAMPUT_MICRO_P_EXO_H_
