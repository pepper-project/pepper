#ifndef APPS_SFDL_GEN_RAMGET_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_RAMGET_MICRO_P_EXO_H_

#include <apps_sfdl_gen/ramget_micro_p.h>
...
*/
class ramget_microProverExo : public ExogenousChecker {
  public:
    ramget_microProverExo();
...
#endif  // APPS_SFDL_GEN_RAMGET_MICRO_P_EXO_H_
