#ifndef APPS_SFDL_GEN_MR_F2_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_F2_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_f2_map_p.h>
...
*/
class mr_f2_mapProverExo : public ExogenousChecker {
  public:
    mr_f2_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_F2_MAP_P_EXO_H_
