#ifndef APPS_SFDL_GEN_MR_MATVEC_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_MATVEC_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_matvec_red_p.h>
#include <apps_sfdl_hw/mr_matvec_red_v_inp_gen_hw.h>
...
*/
class mr_matvec_redProverExo : public ExogenousChecker {
  public:
    mr_matvec_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_MATVEC_RED_P_EXO_H_
