#ifndef APPS_SFDL_GEN_MR_GENOTYPER_RED_P_EXO_H_
#define APPS_SFDL_GEN_MR_GENOTYPER_RED_P_EXO_H_

#include <apps_sfdl_gen/mr_genotyper_red_p.h>
...
*/
class mr_genotyper_redProverExo : public ExogenousChecker {
  public:
    mr_genotyper_redProverExo();
...
#endif  // APPS_SFDL_GEN_MR_GENOTYPER_RED_P_EXO_H_
