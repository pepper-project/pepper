#ifndef APPS_SFDL_GEN_PURE_HASHPUT_P_EXO_H_
#define APPS_SFDL_GEN_PURE_HASHPUT_P_EXO_H_

#include <apps_sfdl_gen/pure_hashput_p.h>
...
*/
class pure_hashputProverExo : public ExogenousChecker {
  public:
    pure_hashputProverExo();
...
#endif  // APPS_SFDL_GEN_PURE_HASHPUT_P_EXO_H_
