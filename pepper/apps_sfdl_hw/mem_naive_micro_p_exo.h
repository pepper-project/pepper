#ifndef APPS_SFDL_GEN_MEM_NAIVE_MICRO_P_EXO_H_
#define APPS_SFDL_GEN_MEM_NAIVE_MICRO_P_EXO_H_

#include <apps_sfdl_gen/mem_naive_micro_p.h>
...
*/
class mem_naive_microProverExo : public ExogenousChecker {
  public:
    mem_naive_microProverExo();
...
#endif  // APPS_SFDL_GEN_MEM_NAIVE_MICRO_P_EXO_H_
