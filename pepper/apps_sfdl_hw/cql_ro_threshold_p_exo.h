#ifndef APPS_SFDL_GEN_CQL_RO_THRESHOLD_P_EXO_H_
#define APPS_SFDL_GEN_CQL_RO_THRESHOLD_P_EXO_H_

#include <apps_sfdl_gen/cql_ro_threshold_p.h>
...
*/
class cql_ro_thresholdProverExo : public ExogenousChecker {
  public:
    cql_ro_thresholdProverExo();
...
#endif  // APPS_SFDL_GEN_CQL_RO_THRESHOLD_P_EXO_H_
