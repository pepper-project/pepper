#ifndef APPS_SFDL_GEN_MR_BSTORE_DOTP_MAP_P_EXO_H_
#define APPS_SFDL_GEN_MR_BSTORE_DOTP_MAP_P_EXO_H_

#include <apps_sfdl_gen/mr_bstore_dotp_map_p.h>
...
*/
class mr_bstore_dotp_mapProverExo : public ExogenousChecker {
  public:
    mr_bstore_dotp_mapProverExo();
...
#endif  // APPS_SFDL_GEN_MR_BSTORE_DOTP_MAP_P_EXO_H_
